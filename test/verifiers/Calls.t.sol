...
contract MyTokenTest is Test {
    ...
    function performTransfer() public returns (bool success, bytes memory result) {
        ...
        bytecode = Utils.replace(bytecode, 0x1234567890AbcdEF1234567890aBcdef12345678, address(myToken));
        bytecode = Utils.replace(bytecode, 0x1231231231231231231231231231231231231231, user);
